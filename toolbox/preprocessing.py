'''nlp preprocessor that removes punctuation, numbers,
brings all text to lowercase, removes stopwords and retains root word,
returns dataframe series containing preprocessed string'''
